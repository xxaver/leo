...
export const Albanian: typeof German = {
    "promptSuggestions": {
        ...
        "schoolFestivalProjects": {
            "prompt": "Çfarë projektesh ka për të parë sot në festën e shkollës?",
            "text": "Festa e shkollës - Projekte"
        },
        "schoolFestivalFood": {
            "prompt": "Çfarë oferta ushqimore ka sot në festën e shkollës?",
            "text": "Festa e shkollës - Ushqimi"
        },
        "nonGerman": {
        ...
        "apology": {
            ...
            "text": "Praktika e justifikimit"
        },
        "timetable": {
            "prompt": "Si duket një orar tipik?",
            "text": "Orari tipik"
        },
        "events": {
            "prompt": "Cilat ngjarje do të zhvillohen së shpejti?",
            "text": "Ngjarjet"
        },
        "news": {
            "prompt": "Çfarë ka të re?",
            "text": "Të rejat"
        },
        "signup": {
    ...
    "footer": {
        "madeBy": "Zhvilluar nga",
        "source": "Kodi burimor",
        "privacyPolicy": "Privatësia",
        "feedback": "Feedback"
    }
};
