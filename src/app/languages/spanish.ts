...
export const Spanish: typeof German = {
    ...
    "promptSuggestions": {
        ...
        "schoolFestivalProjects": {
            "prompt": "¿Qué proyectos se pueden ver hoy en el festival escolar?",
            "text": "Festival Escolar - Proyectos"
        },
        "schoolFestivalFood": {
            "prompt": "¿Qué opciones de comida hay hoy en el festival escolar?",
            "text": "Festival Escolar - Comida"
        },
        "nonGerman": {
        ...
        "apology": {
            ...
            "text": "Política de Ausencias"
        },
        "timetable": {
            "prompt": "¿Cómo es un horario típico?",
            "text": "Horario Típico"
        },
        "events": {
            "prompt": "¿Qué eventos se celebrarán próximamente?",
            "text": "Eventos"
        },
        "news": {
            "prompt": "¿Qué hay de nuevo?",
            "text": "Noticias"
        },
        "signup": {
