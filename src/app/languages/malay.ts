...
export const Malay: typeof German = {
    ...
    "promptSuggestions": {
        ...
        "schoolFestivalProjects": {
            "prompt": "Apakah projek yang boleh dilihat di pesta sekolah hari ini?",
            "text": "Pesta Sekolah - Projek"
        },
        "schoolFestivalFood": {
            "prompt": "Apakah tawaran makanan yang ada di pesta sekolah hari ini?",
            "text": "Pesta Sekolah - Makanan & Minuman"
        },
        "nonGerman": {
        ...
        "apology": {
            ...
            "text": "Amalan Permohonan Maaf"
        },
        "timetable": {
            "prompt": "Bagaimanakah rupa jadual waktu biasa?",
            "text": "Jadual Waktu Biasa"
        },
        "events": {
            "prompt": "Apakah acara yang akan datang?",
            "text": "Acara"
        },
        "news": {
            "prompt": "Apa yang baru?",
            "text": "Berita Terkini"
        },
        "signup": {
