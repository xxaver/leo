...
export const Swedish: typeof German = {
    ...
    "promptSuggestions": {
        ...
        "schoolFestivalSchedule": {
            "prompt": "Vad är schemat för skolfesten?",
            "text": "Skolfest - Program"
        },
        "schoolFestivalProjects": {
            "prompt": "Vilka projekt finns att se på skolfesten idag?",
            "text": "Skolfest - Projekt"
        },
        "schoolFestivalFood": {
            "prompt": "Vilken mat finns det på skolfesten idag?",
            "text": "Skolfest - Mat"
        },
        "nonGerman": {
            "prompt": "Möjligheter för icke-tysktalande?",
            "text": "Finns det möjligheter för icke-tysktalande?"
        },
        "apology": {
            "prompt": "Jag är sjuk och kan inte komma till skolan imorgon. Vad måste mina föräldrar göra?",
            "text": "Frånvaroanmälan"
        },
        "timetable": {
            "prompt": "Hur ser ett typiskt schema ut?",
            "text": "Typiskt schema"
        },
        "events": {
            "prompt": "Vilka evenemang kommer härnäst?",
            "text": "Evenemang"
        },
        "news": {
            "prompt": "Vad är nytt?",
        ...
        "signup": {
            "prompt": "Hur anmäler jag mitt barn?",
            "text": "Anmäl barn"
        }
    },
    "feedback": {
        ...
        "errors": {
            ...
            "rating": "Vänligen ge ett betyg",
            "network": "Fel vid sändning",
    ...
    "reset": {
        "restart": "Börja om",
        "reset": "Återställ",
        "description": "Är du säker på att du vill återställa chatthistoriken?",
        "newChat": "Ny chatt"
    },
    "input": {
