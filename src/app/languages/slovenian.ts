...
export const Slovenian: typeof German = {
    ...
    "promptSuggestions": {
        ...
        "schoolFestivalProjects": {
            "prompt": "Kateri projekti so danes na ogled na šolskem festivalu?",
            "text": "Šolski festival - Projekti"
        },
        "schoolFestivalFood": {
            "prompt": "Kakšna hrana je danes na voljo na šolskem festivalu?",
            "text": "Šolski festival - Gostinstvo"
        },
        "nonGerman": {
        ...
        "apology": {
            ...
            "text": "Pravilnik o odsotnosti"
        },
        "timetable": {
            "prompt": "Kako izgleda tipičen urnik?",
            "text": "Tipičen urnik"
        },
        "events": {
            "prompt": "Kateri dogodki se bližajo?",
            "text": "Dogodki"
        },
        "news": {
            "prompt": "Kaj je novega?",
            "text": "Novice"
        },
        "signup": {
