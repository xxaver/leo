...
export const Swahili: typeof German = {
    ...
    "promptSuggestions": {
        ...
        "schoolFestivalProjects": {
            "prompt": "Kuna miradi gani ya kuona leo kwenye tamasha la shule?",
            "text": "Tamasha la shule - Miradi"
        },
        "schoolFestivalFood": {
            "prompt": "Kuna ofa gani za chakula leo kwenye tamasha la shule?",
            "text": "Tamasha la shule - Chakula"
        },
        "nonGerman": {
        ...
        "apology": {
            ...
            "text": "Utaratibu wa kutoa udhuru"
        },
        "timetable": {
            "prompt": "Ratiba ya kawaida inaonekanaje?",
            "text": "Ratiba ya kawaida"
        },
        "events": {
            "prompt": "Matukio gani yatafanyika hivi karibuni?",
            "text": "Matukio"
        },
        "news": {
            "prompt": "Kuna nini kipya?",
            "text": "Habari"
        },
        "signup": {
