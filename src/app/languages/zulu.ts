...
export const Zulu: typeof German = {
    ...
    "promptSuggestions": {
        ...
        "schoolFestivalProjects": {
            "prompt": "Yimiphi imiklamo ekhona namuhla emkhosini wesikole?",
            "text": "Umkhosi Wesikole - Amaphrojekthi"
        },
        "schoolFestivalFood": {
            "prompt": "Yikuphi ukudla okunikezwayo namuhla emkhosini wesikole?",
            "text": "Umkhosi Wesikole - Ukudla"
        },
        "nonGerman": {
        ...
        "apology": {
            ...
            "text": "Umkhuba Wokuxolisa"
        },
        "timetable": {
            "prompt": "Lubukeka kanjani uhlelo lwezikhathi olujwayelekile?",
            "text": "Uhlelo Lwezikhathi Olujwayelekile"
        },
        "events": {
            "prompt": "Yimiphi imicimbi ezayo maduze?",
            "text": "Imicimbi"
        },
        "news": {
            "prompt": "Yini entsha?",
    ...
    "footer": {
        "madeBy": "Kuthuthukiswe ngu",
        "source": "Ikhodi Yomthombo",
